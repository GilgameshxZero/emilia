...
namespace Emilia {
	// A single envelope represents a fromMailbox, a
	// toMailbox, and email data stored as a filename. Once
	...
	class Envelope {
		...
		// The N-th attempt this envelope has been tried, and
		// the last time it was tried. For PENDING envelopes,
		...
		// The file containing the email data; only those with
		// status PENDING or SUCCESS are guaranteed to be valid
		// files.
