...
* **Extremely long posts**: These posts don't have a `See More` link but rather a `Continue Reading` link, which would open a new tab with the full post. I decided to disregard these posts, since they were few and far in-between.
	...
	![](assets/mit-confessions-bot/long-post.png)
	
	What a pain (to scrape).
* **Non-text posts**: Since we're working with characters here, simply discarding these posts was fine.

As a side, I also scraped the time at which posts were made from the css selector `abbr._5ptz`. You can find the raw scraped data, in JSON, [here](assets/mit-confessions-bot/fetch.zip).

### Cleaning & Preparation

![](assets/mit-confessions-bot/psa.png)
...
* **Weights**: [.hdf5](assets/mit-confessions-bot/first-model-weights.hdf5)
...
* **Samples**
	* [10000 characters sampling from the output distribution](assets/mit-confessions-bot/first-model-sample-10000.txt)
	* [10000 characters with `argmax` on the output distribution](assets/mit-confessions-bot/first-model-sample-10000-argmax.txt)
...
![](assets/mit-confessions-bot/course-6.png)
...
![](assets/mit-confessions-bot/seals.png)
...
* **Weights**: [.hdf5](assets/mit-confessions-bot/second-model-weights.hdf5)
...
![](assets/mit-confessions-bot/model-training.png)
...
* **Weights**: [.hdf5](assets/mit-confessions-bot/third-model-weights.hdf5)
...
* **Samples**
	* [10000 characters at `temperature = 0.15`](assets/mit-confessions-bot/third-model-sample-10000-0.15.txt)
	* [10000 characters at `temperature = 0.35`](assets/mit-confessions-bot/third-model-sample-10000-0.35.txt)
	* [10000 characters at `temperature = 0.80`](assets/mit-confessions-bot/third-model-sample-10000-0.80.txt)
...
![](assets/mit-confessions-bot/loss-epochs.png)
...
![](assets/mit-confessions-bot/paul-graham.png)
...
* [10000 characters at `sequence length = 5`](assets/mit-confessions-bot/char-n-gram-10000-5.txt)
* [10000 characters at `sequence length = 10`](assets/mit-confessions-bot/char-n-gram-10000-10.txt)
* [10000 characters at `sequence length = 15`](assets/mit-confessions-bot/char-n-gram-10000-15.txt)
...
![](assets/mit-confessions-bot/selenium-python.png)
...
![](assets/mit-confessions-bot/trung-post.png)
