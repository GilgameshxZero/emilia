		...
		else
		{
			...
			else
			{
				...
				headerinfo = std::string ("HTTP/1.1 200 OK\r\n") +
					...
					"Accept-Ranges: bytes\r\n" +
					"Connection: close\r\n" +
					"Personal-Message: Hey guys, Yang/Gilbert here! Hope you're having a good day :)\r\n" +
					"Who-Is-Best-Girl: Emilia, of course!\r\n" + +
					"Hi-Stella: Why would you eat popsicles in winter...\r\n" +
					"Earth-chan: Earth-chan is not flat, please don't bully her anymore guys UwU\r\n" +
					"\r\n";
				error = Rain::SendText (*rfparam->sock, headerinfo.c_str (), headerinfo.length ());
				if (error) return 1;
